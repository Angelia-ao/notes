  ...
  <body>
    ...
    <div id="MAINA">
      <div class="mindexa">
        ...
        <div class="mright">
          <h3>平台公钥数据加密<span>(带*项为必填)</span></h3>
            <div class="mrmain">
              <form name="subForm" action="tools_Encrypt_2.php" method="post" style="margin:0px">
                <table>

                  <tbody>
                    <tr>
                      <th>需加密数据【data1】：</th>
                      <td><textarea name="data1" cols="40" rows="3" class="text" name="data1" value=""/></textarea> <span>*</span></td>
                    </tr>
