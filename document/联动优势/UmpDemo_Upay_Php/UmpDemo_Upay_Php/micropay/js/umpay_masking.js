...
var IMGFOLDERPATH = '../micropay/img/';//图片路径配置
...
if ( !this.ParentWindow ){
	...
	arr.push("    <td width='13' height='45' style=\"background-image:url("+IMGFOLDERPATH+"dialog_lt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+IMGFOLDERPATH+"dialog_lt.png', sizingMethod='crop');\"><div style='width:13px;'></div></td>");
	arr.push("    <td height='45' style=\"background-image:url("+IMGFOLDERPATH+"dialog_ct.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+IMGFOLDERPATH+"dialog_ct.png', sizingMethod='crop');\"><div style=\"float:left;font-weight:bold; color:#FFFFFF;font-size:14px; padding:9px 0 0 0;\"><img src=\""+IMGFOLDERPATH+"icon_dialog.gif\" align=\"absmiddle\">&nbsp;"+this.Title+"</div>");
	...
	arr.push("    <td width='13' height='45' style=\"background-image:url("+IMGFOLDERPATH+"dialog_rt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+IMGFOLDERPATH+"dialog_rt.png', sizingMethod='crop');\"><div style=\"width:13px;\"></div></td>");
	arr.push("  </tr>");
	...
	arr.push("        </div></td></tr>");
	arr.push("        <tr drag='false' id='_ButtonRow_"+this.ID+"' style='display:none'><td height='36'>");
...
function zConfirm(){
	Dialog.confirm('是否操作？',function(){Dialog.alert("是");});
}
...
function umpay_reqpay(form_id){
	...
	var req_url = getUrl(form_obj);
	umpay_poplayer(req_url);
	//alert(req_url);
}

function getUrl(form_obj){
