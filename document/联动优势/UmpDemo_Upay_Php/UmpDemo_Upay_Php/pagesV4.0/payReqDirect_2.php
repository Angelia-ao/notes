            ...
            <table>
              <tbody>
				...
				<tr>
                 ...
                 -->
                <tr>
                  <td colspan="2"><div class="pbutton2 pline" align="center"><input type="submit" value="提交" class="button" onClick="if(confirm('数据将提交到联动优势支付平台，是否继续？'))location.href= '<?php echo $url; ?>';else{return false;}"/>
                  <input type="button" value="查看代码" class="button" onClick="document.getElementById('codeDiv').style.display='block';"/></div></td>
                </tr>
              </tbody>
            </table>
...
require_once ('mer2Plat.php');
	...
	$reqData = MerToPlat::requestTransactionsByGet($map);//这个是重要的
	$url = $reqData->getUrl();//访问此URL可以进行分账下单
