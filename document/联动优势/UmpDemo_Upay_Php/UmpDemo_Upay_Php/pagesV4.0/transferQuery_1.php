	...
	<div id="MAINA">
		<div class="mindexa">
          ...
          <?php include("./left.php");?>
			...
			<div class="mright">
				<h3>
					付款API订单状态查询<span>(带*项为必填)</span>
				</h3>
				<div class="mrmain">
					<form name="subForm" action="./transferQuery_2.php" method="post"
						style="margin: 0px">
						<table>
							<tbody>
								<tr>
									...
									<td><select name="service">
											<option value="transfer_query" selected>transfer_query</option>
									</select></td>
								</tr>
								<tr>
									<th>字符编码【charset】：</th>
