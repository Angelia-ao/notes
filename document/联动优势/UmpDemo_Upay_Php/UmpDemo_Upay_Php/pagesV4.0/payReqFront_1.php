	...
	<div id="MAINA">
		<div class="mindexa">
          ...
          <?php include("./left.php");?>
			...
			<div class="mright">
				<h3>Web收银台<span>(带*项为必填)</span>
				</h3>
				<div class="mrmain">
					<form name="subForm" action="./payReqFront_2.php" method="post"
						style="margin: 0px">
						<table>
					            <tbody>
              <tr>
                    <th nowrap="nowrap">接口名称【service】：</th>
                    <td nowrap="nowrap"><input type="text" class="wtxt" name="service" value="pay_req_split_front"/> <span>*</span></td>
                </tr>
                <tr>
