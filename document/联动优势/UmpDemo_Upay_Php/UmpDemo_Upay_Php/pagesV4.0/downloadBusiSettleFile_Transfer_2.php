...
<?php 
	...
	$settle_date=$_REQUEST['settle_date'];
	$settle_type = $_REQUEST['settle_type'];
	...
	$map->put("settle_type",$settle_type);
          ...
          <div class="mrmain">
            ...
            <table>
              <tbody>
				...
				<tr>
                  <th nowrap>对账日期【settle_date】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['settle_date'];?></strong><input type="hidden" name="settle_date" value="<?php echo $_REQUEST['settle_date'];?>"/></td>
                </tr>
                <tr>
                  <th nowrap>对账类型【settle_type】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['settle_type'];?></strong><input type="hidden" name="settle_type" value="<?php echo $_REQUEST['settle_type'];?>"/></td>
				</tr>
				<tr>
