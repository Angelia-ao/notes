          ...
          <div class="mrmain">
            ...
            <table>
              <tbody>
				...
				<tr>
                  <th nowrap>订单类型【order_type】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['order_type'];?></strong><input type="hidden" name="order_type" value="<?php echo $_REQUEST['order_type'];?>"/></td>
				</tr>
				<tr>
