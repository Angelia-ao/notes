...
<?php 
	...
	$org_amount=$_REQUEST['org_amount'];
            ...
            <table>
              <tbody>
               <tr>
                 ...
                 <tr>
                  <th nowrap>退款结果通知地址【notify_url】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['notify_url'];?></strong><input type="hidden" name="notify_url" value="<?php echo $_REQUEST['notify_url'];?>"/></td>
                </tr>
                <tr>
				...
				<tr>
                  <th nowrap>退款号【refund_no】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['refund_no'];?></strong><input type="hidden" name="refund_no" value="<?php echo $_REQUEST['refund_no'];?>"/></td>
				</tr>
				<tr>
				...
				<tr>
                  <th nowrap>退款金额【refund_amount】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['refund_amount'];?></strong><input type="hidden" name="refund_amount" value="<?php echo $_REQUEST['refund_amount'];?>"/></td>
				</tr>
				<tr>
                  <th nowrap>交易金额【org_amount】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['org_amount'];?></strong><input type="hidden" name="org_amount" value="<?php echo $_REQUEST['org_amount'];?>"/></td>
				</tr>
				<tr>
...
//商户分账退款接口，生成请求URL代码
	...
	$url = $reqData->getUrl();//访问此URL可以进行退费交易
