          ...
          <div class="mrmain">
            ...
            <table>
              <tbody>
				...
				<tr>
                  <th nowrap>嗖付交易号【trade_no】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['trade_no'];?></strong><input type="hidden" name="trade_no" value="<?php echo $_REQUEST['trade_no'];?>"/></td>
				</tr>
				<tr>
                  <th nowrap>商品号【goods_id】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['goods_id'];?></strong><input type="hidden" name="goods_id" value="<?php echo $_REQUEST['goods_id'];?>"/></td>
				</tr>
				<tr>
                  <th nowrap>媒介标识【media_id】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['media_id'];?></strong><input type="hidden" name="media_id" value="<?php echo $_REQUEST['media_id'];?>"/></td>
				</tr>
				<tr>
                  <th nowrap>媒介类型【media_type】：</th>
                  <td nowrap><strong><?php echo $_REQUEST['media_type'];?></strong><input type="hidden" name="media_type" value="<?php echo $_REQUEST['media_type'];?>"/></td>
				</tr>
...
<pre name="code" class="php" id="code">
	...
	$reqData = MerToPlat::requestTransactionsByGet($map);
	$url = $reqData->getUrl();//访问此URL可以查询订单信息
