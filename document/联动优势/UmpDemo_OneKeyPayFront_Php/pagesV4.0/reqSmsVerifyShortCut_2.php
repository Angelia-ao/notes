						...
						<tbody>
							...
							<tr>
			                 ...
			                 <tr>
			                  ...
			                  <td nowrap="nowrap"><strong><?php echo $_REQUEST['mer_cust_id'];?></strong> </td>
			                </tr>
			                <tr>
			                  <th nowrap="nowrap">用户业务协议号【usr_busi_agreement_id】：</th>
			                  <td nowrap="nowrap"><strong><?php echo $_REQUEST['usr_busi_agreement_id'];?></strong></td>
			                </tr>
			               <tr>
			                  <th nowrap="nowrap">支付协议号【usr_pay_agreement_id】：</th>
			                  <td nowrap="nowrap"><strong><?php echo $_REQUEST['usr_pay_agreement_id'];?></strong></td>
			                </tr>
